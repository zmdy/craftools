...
export interface CraftoolsImageEl extends HTMLElement {
  _craftoolsMeta?: Record<string, any>;
  contentArea?:    HTMLElement;
}

export class ImageFilters {
  static getFiltersString(meta: Record<string, any> | undefined): string {
  ...
  static applyFilters(element: CraftoolsImageEl): void {
