...
I18n.addTranslations('agendaExportTool', {
    "pt-br": {
        ...
        repeatModeComputedHint: "Calculado automaticamente: {n} repetições, a partir da data desta página.",
    ...
    "en": {
        ...
        repeatModeComputedHint: "Automatically calculated: {n} repetitions, starting from this page's date.",
    ...
    "es": {
        ...
        repeatModeComputedHint: "Calculado automáticamente: {n} repeticiones, a partir de la fecha de esta página.",
