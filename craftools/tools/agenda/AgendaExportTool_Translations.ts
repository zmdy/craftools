...
I18n.addTranslations('agendaExportTool', {
    "pt-br": {
        ...
        nextPageContinueOption: "Continuar com: {page}",
        nextPageBackToOption: "Voltar para: {page} (fecha o ciclo)",
        cycleCountLabel: "Repetir esse bloco quantas vezes",
    ...
    "en": {
        ...
        nextPageContinueOption: "Continue with: {page}",
        nextPageBackToOption: "Loop back to: {page} (closes the cycle)",
        cycleCountLabel: "How many times to repeat this block",
    ...
    "es": {
        ...
        nextPageContinueOption: "Continuar con: {page}",
        nextPageBackToOption: "Volver a: {page} (cierra el ciclo)",
        cycleCountLabel: "Cuántas veces repetir este bloque",
