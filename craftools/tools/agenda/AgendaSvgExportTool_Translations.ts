...
I18n.addTranslations('agendaSvgExportTool', {
    "pt-br": {
        ...
        mergeToggle: "Gerar um único arquivo SVG (páginas empilhadas verticalmente). Desmarque para baixar um arquivo separado por página.",
    ...
    "en": {
        ...
        mergeToggle: "Generate a single SVG file (pages stacked vertically). Uncheck to download one file per page instead.",
    ...
    "es": {
        ...
        mergeToggle: "Generar un único archivo SVG (páginas apiladas verticalmente). Desmarca para descargar un archivo separado por página.",
        exportButton: "Exportar Agenda (SVG)",
