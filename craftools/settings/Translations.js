export const Translations = {
    "pt-br": {
        ...
        sizes: {
            ...
            screen: {
                freeform: "*",
                freeformDesc: "Importe sua foto e comece a editar!"
            },
            socialMedia: {
                instagramSquare: "Instagram - Quadrado",
                instagramSquareDesc: "Vamos começar!"
            }
        }
    },
    "en": {
        ...
        sizes: {
            paper: {
                a4: "A4",
                a4Desc: "Great for letterhead, planners, certificates",
                a4Landscape: "A4 Landscape",
                a4LandscapeDesc: "Great for letterhead, planners, certificates",
                a6: "A6",
                a6Desc: "Great for printing photos",
                a5: "A5",
                a5Desc: "Posters, large invitations, folded materials",
                a3: "A3",
                a3Desc: "Posters, large invitations, folded materials"
            },
            screen: {
                freeform: "*",
                freeformDesc: "Import your photo and start editing!"
            },
            socialMedia: {
                instagramSquare: "Instagram - Square",
                instagramSquareDesc: "Let's get started!"
            }
        }
    },
    "es": {
        ...
        sizes: {
            paper: {
                a4: "A4",
                a4Desc: "Ideal para papel timbrado, agendas, certificados",
                a4Landscape: "A4 Horizontal",
                a4LandscapeDesc: "Ideal para papel timbrado, agendas, certificados",
                a6: "A6",
                a6Desc: "Ideal para impresión de fotos",
                a5: "A5",
                a5Desc: "Carteles, invitaciones grandes, materiales plegados",
                a3: "A3",
                a3Desc: "Carteles, invitaciones grandes, materiales plegados"
            },
            screen: {
                freeform: "*",
                freeformDesc: "¡Importa tu foto y empieza a editar!"
            },
            socialMedia: {
                instagramSquare: "Instagram - Cuadrado",
                instagramSquareDesc: "¡Vamos a empezar!"
            }
        }
    }
};
