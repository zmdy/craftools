    ...
    private static _dateConfig(b: VariableBinding): string {
        ...
        return `
            ...
            ${this._pillGroup(I18n.t('variablePanel.dateRepetitionScopeLabel'), 'var-date-repetition-scope-btn', [
                ...
                ['chain',    I18n.t('variablePanel.dateRepetitionScopeChain')],
        ...
        const bindConfigFields = (): void => {
            ...
            switch (binding.type) {
                case 'date': {
                    ...
                    this._bindPillGroup(container, 'var-date-repetition-scope-btn', v => { binding!.repetitionScope = v as 'instance' | 'cycle' | 'chain'; }, notify);
