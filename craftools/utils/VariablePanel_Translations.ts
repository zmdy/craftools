...
I18n.addTranslations('variablePanel', {
    "pt-br": {
        ...
        dateRepetitionScopeHint: "Use \"Repetição desta página\" (padrão) para datas que devem fluir continuamente, como os dias de um mês. Use \"Ciclo completo do bloco\" quando esta página estiver encadeada com outra (ex.: uma página de \"mês\" ligada a uma página de \"dias\", repetindo o bloco 12x) e precisar avançar 1 vez por ciclo, não 1 vez por página gerada -- caso contrário o mês pode avançar rápido demais e mostrar o mês errado.",
    ...
    "en": {
        ...
        dateRepetitionScopeHint: "Use \"This page's own repetition\" (default) for dates that should flow continuously, like the days of a month. Use \"Full block cycle\" when this page is chained to another (e.g. a \"month\" page linked to a \"days\" page, repeating the block 12x) and needs to advance once per cycle, not once per generated page -- otherwise the month can advance too fast and show the wrong month.",
    ...
    "es": {
        ...
        dateRepetitionScopeHint: "Use \"Repetición de esta página\" (predeterminado) para fechas que deben fluir de forma continua, como los días de un mes. Use \"Ciclo completo del bloque\" cuando esta página esté encadenada con otra (ej.: una página de \"mes\" vinculada a una página de \"días\", repitiendo el bloque 12 veces) y necesite avanzar 1 vez por ciclo, no 1 vez por página generada -- de lo contrario el mes puede avanzar demasiado rápido y mostrar el mes equivocado.",
