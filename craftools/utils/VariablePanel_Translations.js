...
I18n.addTranslations('variablePanel', {
    "pt-br": {
        ...
        apiPhraseFieldLabel: "Campo do JSON (opcional)",
        apiPhraseFieldPlaceholder: "ex: texto",
        apiPhraseFieldHelp: "Deixe em branco para detectar automaticamente.",
    ...
    "en": {
        ...
        apiPhraseFieldLabel: "JSON field (optional)",
        apiPhraseFieldPlaceholder: "e.g.: text",
        apiPhraseFieldHelp: "Leave blank to auto-detect.",
    ...
    "es": {
        ...
        apiPhraseFieldLabel: "Campo del JSON (opcional)",
        apiPhraseFieldPlaceholder: "ej: texto",
        apiPhraseFieldHelp: "Déjelo en blanco para detectar automáticamente.",
